...
COMPUTE_BOX = '/Users/surya/Projects/Vagrant-Boxes/r10.box'
CONTROLLER_BOX = '/Users/surya/Projects/Vagrant-Boxes/r10-controller.box'
...
Vagrant.configure('2') do |config|
  ...
  NODES.each do |name, ip|
    config.vm.box = (name == 'controller') ? CONTROLLER_BOX : COMPUTE_BOX
